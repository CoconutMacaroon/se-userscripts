...
(() => {
    ...
    $(() => {
        if ((/^https:\/\/[A-Za-z\.]{2,}\/questions\/[0-9]/).test(window.location.toString())) {
            ...
            const VISIBLE = `<i class="bi bi-arrows-collapse"></i>`, HIDDEN = `<i class="bi bi-arrows-expand"></i>`;
            ...
            const generateTable = () => {
                ...
                saveBtn.innerHTML = `<i class="bi bi-download"></i> Save hidden posts`;
            ...
            const addHideBtn = () => {
                ...
                for (let i = 0; i < search.length; ++i) {
                    ...
                    btn.classList.add("s-btn__outlined");
                    btn.onclick = () => {
            ...
            const init = () => {
                ...
                bootstrapIcons.href = "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-icons/1.11.3/font/bootstrap-icons.min.css";
                bootstrapIcons.integrity = "sha512-dPXYcDub/aeb08c63jRq/k6GaKccl256JQy/AnOq7CAnEZ9FzSL9wSbcZkMp4R26vBsMLFYH4kQ67/bbV8XaCQ==";
